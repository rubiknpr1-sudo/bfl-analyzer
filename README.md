...
**Живой стенд:** https://bfl.91-218-246-12.sslip.io
...
- **TLS**: стенд за nginx с сертификатом Let's Encrypt, HTTP → HTTPS редирект, HSTS. Приложение слушает только 127.0.0.1.
